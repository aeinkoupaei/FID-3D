...
- Examples and CLI share the same underlying API.
- Set seeds via `fid3d.utils.set_seed` for deterministic behavior where possible.

## Citation

If you use this code in your work, please cite the original FID paper and your chosen backbone. A placeholder BibTeX entry:

```
@misc{fid3d2025,
  title   = {FID-3D: Frechet Inception Distance for 3D Medical Images},
  author  = {Your Name},
  year    = {2025},
  note    = {https://github.com/yourname/fid3d}
}
```
